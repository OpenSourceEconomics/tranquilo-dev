...
%\SetSymbolFont{symbols}{sans}{LMS}{ntxsy}{m}{n}
	% From http://mirrors.ctan.org/fonts/newtx/tex/newtxmath.sty
...
\SetMathAlphabet{\mathit} {normal}{T1}{\savermfamily}{\savermmdseries}{it}
\SetMathAlphabet{\mathit} {bold}  {T1}{\savermfamily}{\savermbfseries}{it}
...
\SetMathAlphabet{\mathcal}{sans}{LMS}{ntxsy}{m}{n}
...
% Using symbols like \int, \left(, etc. from newtxmath:
...
%\SetSymbolFont{symbols}{sansup}{LMS}{ntxsy}{m}{n}
	% From http://mirrors.ctan.org/fonts/newtx/tex/newtxmath.sty

\DeclareMathVersion{boldsans}
%\SetSymbolFont{operators}{boldsans}{OT1}{jkpss}{b}{n}
%	% From http://mirrors.ctan.org/fonts/kpfonts/latex/kpfonts.sty
%\SetSymbolFont{operators}{boldsans}{OT1}{ntxtlf}{bx}{n}
...
% From http://mirrors.ctan.org/fonts/kpfonts/latex/kpfonts.sty
\SetSymbolFont{letters} {boldsans}{OML}{nxlmi} {b}{it}
\SetSymbolFont{lettersA}{boldsans}{U}  {ntxmia}{b}{it}
...
\SetMathAlphabet{\mathcal}{boldsans}{LMS}{ntxsy}{b}{n}
...
\SetSymbolFont{letters} {boldsans}  {OML}{nxlmi} {b}{it}
\SetSymbolFont{lettersA}{boldsansup}{U}  {ntxmia}{b}{it}
\SetSymbolFont{symbols} {boldsansup}{LMS}{ntxsy} {b}{n}
\SetSymbolFont{lettersA}{normalup}  {U}  {ntxmia}{m}{it}
\SetSymbolFont{lettersA}{boldup}    {U}  {ntxmia}{b}{it}
	% From http://mirrors.ctan.org/fonts/newtx/tex/newtxmath.sty
	% Upright Greek characters are taken from the lettersA font.
...
%\DeclareSymbolFontAlphabet{\mathrm}{uprightglyphs}
%\SetMathAlphabet{\mathrm}{normal}{OT1}{\savermfamily}{\savermmdseries}{n}
...
\DeclareMathSymbol{:}{\mathrel}  {uprightglyphs}{`:}
\let\colon\relax
\DeclareMathSymbol{\colon}{\mathpunct}{uprightglyphs}{`;}
\DeclareMathSymbol{;}{\mathpunct}{uprightglyphs}{`;}
\DeclareMathSymbol{/}{\mathord}  {uprightglyphs}{`/}
%\DeclareMathSymbol{/}{\mathop}   {uprightglyphs}{`/}
%	% This would icrease the spacing around the division slash slightly
\DeclareMathSymbol{!}{\mathord}  {uprightglyphs}{`!}
\DeclareMathSymbol{\mathdollar}{\mathord}{uprightglyphs}{`\$}
\DeclareRobustCommand{\$}{\ifmmode\mathdollar\else\symbol{`\$}\fi}
\DeclareMathSymbol{\mathpercent}{\mathord}{uprightglyphs}{`\%}
\DeclareRobustCommand{\%}{\ifmmode\mathpercent\else\symbol{`\%}\fi}
\DeclareMathSymbol{&}{\mathbin}{uprightglyphs}{`&}
...
% Redefine \cdots so that its appearance matches \ldots, \ddots, and \vdots:
%%% Use math italic, not text, version of dot, in \vdots and \ddots definitions
\makeatletter
\def\cdots{\mathinner{\mkern1mu\raise2.5\p@
    \vbox{\kern7\p@\hbox{$\m@th.$}}\mkern4mu
    \raise2.5\p@\hbox{$\m@th.$}\mkern4mu\raise2.5\p@\hbox{$\m@th.$}\mkern1mu}}
    % \raise2.5\p@ instead of \raise4\p@ to match \cdot
    % \mkern4mu  instead of \mkern2mu  to match \ldots
% Inspired by:
...
\makeatother
	% Based on http://mirrors.ctan.org/fonts/newtx/tex/newtxmath.sty
...
\@for\@tempa:=%
	...
	omicron,pi,varpi,rho,varrho,sigma,varsigma,tau,upsilon,phi,chi,psi,omega,digamma,%
...
% ==>
%\DeclareMathAlphabet{\mathrm}{OT1}{\savermfamily}{\savermmdseries}{n}
...
\renewcommand{\mathrm}[1]{%
	{\textup{%
		\protect\InUpModetrue%
		\IfInBoldMode%
			\mathversion{boldup}%
			\protect\upgreekletters%
			\(#1\)%
		\else%
			\mathversion{normalup}%
			\protect\upgreekletters%

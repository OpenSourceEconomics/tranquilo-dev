...
\usepackage[backend=bibtex, natbib=true, bibencoding=inputenc, bibstyle=authoryear, citestyle=authoryear-comp, mincitenames=1, maxcitenames=2, minbibnames=1, maxbibnames=7, uniquename=false, uniquelist=true, giveninits=true, backref=false, doi=false, url=false, isbn=false, dashed=false, sorting=nyt, sortcites=true, mergedate=true, dateabbrev=false, abbreviate=false, citetracker=true]{biblatex}

...
\definechangesauthor[name={Janoś}, color=mediumelectricblue]{JG}
\definechangesauthor[name={HM}, color=internationalorange]{HM}
\definechangesauthor[name={Jürgen}, color=electricultramarine]{JM}
\definechangesauthor[name={Mariam}, color=lavenderindigo]{MP}
